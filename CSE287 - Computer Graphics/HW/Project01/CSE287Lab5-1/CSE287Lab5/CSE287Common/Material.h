...
public:
	...
	/** @brief	True if is dielectric and BOTH transmits and reflects light,
	false if not */
	bool isDielectric = true;
	/** @brief	Emissive color of the surface */
	color emissiveColor =  color(0.0, 0.6, 0.0, 0.05);
	...
	virtual void setEmisive(const color col) { emissiveColor = col; }
