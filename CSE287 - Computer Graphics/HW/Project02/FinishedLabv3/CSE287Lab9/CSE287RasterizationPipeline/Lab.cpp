...
Sphere blueSphere(color(0.0, 0.0, 1.0, 1.0), 1.0, 15, 15);
...
void renderObjects()
{
	...
	PerVertex::modelingTransformation = glm::translate(dvec3(-3.0, -2.0, 3.0));


	// Send the reference plane vertices down the pipeline
	PerVertex::fetchTriangleVertices(greenBox.boxVertices);


	// Set Modeling transformation for the pyramid
	PerVertex::modelingTransformation = glm::translate(dvec3(3.5, -2.5, -3.75));


	// Send the reference plane vertices down the pipeline
	PerVertex::fetchTriangleVertices(blackBox.boxVertices);


	// Set modeling transformation for the center pyramid
	PerVertex::modelingTransformation = glm::translate(dvec3(3.5, -1.5, -3.75));

	// Send the reference plane vertices down the pipeline
	PerVertex::fetchTriangleVertices(blackPyramid.triangleVertices);

	// Set modeling transformation for some center pyramids
	PerVertex::modelingTransformation = glm::translate(dvec3(0, -2.5, 0));

	// Send the reference plane vertices down the pipeline
	PerVertex::fetchTriangleVertices(redBox.boxVertices);

	// Set modeling transformation for some center pyramids
	PerVertex::modelingTransformation = glm::translate(dvec3(-1, -2.5, -1));

	// Send the reference plane vertices down the pipeline
	PerVertex::fetchTriangleVertices(yellowBox.boxVertices);

	// Set modeling transformation for some center pyramids
	PerVertex::modelingTransformation = glm::translate(dvec3(1, -2.5, -1));

	// Send the reference plane vertices down the pipeline
	PerVertex::fetchTriangleVertices(blueBox.boxVertices);

	// Set modeling transformation for some center pyramids
	PerVertex::modelingTransformation = glm::translate(dvec3(0, -1.5, 0)) * glm::rotate(glm::radians(45.0), dvec3(0, 1, 0));

	// Send the reference plane vertices down the pipeline
	PerVertex::fetchTriangleVertices(whiteBox.boxVertices);
	...
	// Send the pyramid vertices down the pipeline
	PerVertex::fetchTriangleVertices(blueSphere.triangleVertices);
