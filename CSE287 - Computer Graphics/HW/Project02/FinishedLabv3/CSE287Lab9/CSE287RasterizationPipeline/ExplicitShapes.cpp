...
Box::Box(color cubeColor, float width, float height, float depth) {
	...
	boxVertices.push_back(VertexData(ftr, c, n));
	boxVertices.push_back(VertexData(ftl, c, n));
	boxVertices.push_back(VertexData(fbl, c, n));
	
	n = dvec4(findUnitNormal(fbl.xyz, fbr.xyz, ftr.xyz), 0.0);

	boxVertices.push_back(VertexData(fbl, c, n));
	boxVertices.push_back(VertexData(fbr, c, n));
	boxVertices.push_back(VertexData(ftr, c, n));
	...
	boxVertices.push_back(VertexData(ftl, c, n));
	boxVertices.push_back(VertexData(btl, c, n));
	boxVertices.push_back(VertexData(bbl, c, n));
	...
	boxVertices.push_back(VertexData(btr, c, n));
	boxVertices.push_back(VertexData(ftr, c, n));
	boxVertices.push_back(VertexData(fbr, c, n));
	...
	boxVertices.push_back(VertexData(fbr, c, n));
	boxVertices.push_back(VertexData(bbr, c, n));
	boxVertices.push_back(VertexData(btr, c, n));
