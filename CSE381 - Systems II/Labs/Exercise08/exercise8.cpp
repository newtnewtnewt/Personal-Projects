 ...
 *     3. If not cgi-bin, then --
 *          3.1. It checks to see if a file exists and returns contents of file
 *          3.2. Otherwise it responds with a 404.
 * 
 * 
 */
...
/** Forward declaration for method defined further below.  The forward
    declaration is needed only because of the way this solution is
    setup to try to clearly isolate the part of the program that
    students should be modifying
 */
