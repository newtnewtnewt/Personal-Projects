 ...
 * outside) the canvas is permitted—however, only the part of the object that
 ...
 * segment from (0.5, –&infin;) to (0.5, &infin;) may not be visible even in
 * the part of the canvas where it should be.
 * </ul>
 * <p>
...
public final class StdDraw implements ActionListener, MouseListener, MouseMotionListener, KeyListener {
	 ...
	 * {@code line()}, {@code circle()}, and {@code square()} will be deffered until
	...
	/**
	 * Disable double buffering. All subsequent calls to drawing methods such as
