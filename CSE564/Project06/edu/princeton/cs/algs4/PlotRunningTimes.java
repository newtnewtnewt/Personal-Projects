...
public class PlotRunningTimes {
	...
	public static void main(String[] args) throws FileNotFoundException {
		 ...
		 */
		int[] nVals = new int[100];
		for(int i = 0; i < 100000; i = i + 1000) {
			nVals[i/1000] = i;
		}
		double[] averageRuns = new double[100]; 
		double[] stdDev = new double[100];
			
		Scanner sc = new Scanner(new File("test6.txt"));
	...
	public static void plotter(int[] nValues, double[] timeValues, double[] stdDev) {
		...
		StdDraw.text(0.5, 0.025, "# of Additional Edges");
		...
		StdDraw.text(0.05, 0.7, "" + (((int)((timeValues[timeValues.length-1])*1000))/1000.0));
