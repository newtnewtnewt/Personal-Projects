...
<html lang="en">
  <head>
	...
	<script src = "qlSubmission.js"></script>
  </head>
  <body>
	...
	<nav class="navbar navbar-inverse" style="background-color: #4BA630;border-color: #4BA630;">
	  ...
	  <div class="container-fluid">
		...
		<ul class="nav navbar-nav">
		  ...
		  <li class="active"><a href="setQuickLinks.php" style="color:#FFFFFF;">Set Quick Links</a></li>
		</ul>
	  </div>
	</nav>
	<div class="container">
	  ...
	  <div><label>Submit a new link </label></div>
	  <form class="form-inline" style="padding-left:100px">
			<label for="title">Title:</label>
			<input placeholder="Ghosts of the Mississippi" type="text" class="form-control" id="title" required>
			<label for="link">Link:</label>
			<input type="text" placeholder="http://ghostsOfTheMississippi.com" class="form-control" id="link" required>
			<input type="submit" id="submitButton" class="btn btn-danger form-control"></button>
	  </form>
    </div>
