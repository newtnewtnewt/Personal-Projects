...
function getNetwork() {
    ...
    .fail(function(error) {
    var date = Date();
	$("#log").append("<li> " + date.toLocaleString() + " Error getting network " + "</li>");
  });
...
function getUsers(){
    ...
    .fail(function(error) {
		...
		$("#log").append("<li> " + date.toLocaleString() + " Error getting Who " + " </li>");
  });
...
function getLoad() {
	...
	$("#log").append("<li>" + date.toLocaleString() + " Error getting loadavg" + "</li>");
  });
