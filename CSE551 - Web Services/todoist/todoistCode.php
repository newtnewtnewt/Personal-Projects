...
try {
  $data = array("client_id"=>$clientID,"client_secret"=>$clientSecret,"code"=>$code,'redirect_uri'=>'https://dunnnm2.451.csi.miamioh.edu/cse451-dunnnm2-web/todoist/index.php');
